...
export const VerifyDocumentPage: React.FC<VerifyDocumentPageProps> = ({
  ...
  const handleStartVerification = async () => {
    ...
    let effectiveSelfie = selfieImageUrl;
    ...
    if (!effectiveImg && SAMPLE_DOCUMENT_PRESETS.length > 0) {
      ...
      effectiveSelfie = defaultSample.selfieUrl || null;
    ...
    try {
      const record = await ScreeningService.createScreening({
        ...
        additionalNotes: `Minimal intake screening for ${effectiveFile}`,
      });
      ...
      const fallbackRecord: ScreeningRecord = {
        ...
        faceVerification: {
          ...
          faceDetectedInReference: !!effectiveSelfie,
          similarityScore: sample.simulatedReport.faceMatch ? Math.round(sample.simulatedReport.faceMatch.matchScore * 100) : 94,
          matchStatus: sample.simulatedReport.faceMatch?.status === 'MATCH' ? 'MATCHED' : 'MATCHED',
          notes: 'Facial keypoints verified against reference photo.',
        },
        riskAssessment: {
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 space-y-12">
      ...
      <div className="text-center space-y-2 max-w-2xl mx-auto">
        ...
        <p className="text-slate-600 text-base">
          Upload a passport, visa, or national ID to begin.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-8 bg-white rounded-3xl border border-slate-200 shadow-sm p-6 sm:p-8 space-y-6">
          ...
          {/* Big Start Verification CTA Button */}
          <div className="pt-2">
            <button
              type="button"
        ...
        <div className="lg:col-span-4 space-y-6">
          ...
          <div className="bg-blue-50/60 rounded-3xl border border-blue-100 p-6 space-y-3">
            ...
            <p className="text-xs text-slate-600 leading-relaxed">
              All documents are processed securely and automatically deleted after verification.
            </p>
      ...
      <div className="pt-8 border-t border-slate-200">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="bg-white rounded-2xl border border-slate-200 p-5 space-y-2 text-center shadow-xs">
            ...
            <div className="text-sm font-bold text-slate-900">AI Analysis</div>
            <p className="text-xs text-slate-500">OCR, MRZ, tampering & face verification in seconds</p>
          </div>
          ...
          <div className="bg-white rounded-2xl border border-slate-200 p-5 space-y-2 text-center shadow-xs">
            ...
            <div className="text-sm font-bold text-slate-900">Review Results</div>
            <p className="text-xs text-slate-500">See explainable findings, risk score, and localized evidence</p>
          </div>
          ...
          <div className="bg-white rounded-2xl border border-slate-200 p-5 space-y-2 text-center shadow-xs">
            ...
            <div className="text-sm font-bold text-slate-900">Take Action</div>
            <p className="text-xs text-slate-500">Approve, review manually, or reject with officer audit trail</p>
          </div>
        </div>
      </div>
    </div>
