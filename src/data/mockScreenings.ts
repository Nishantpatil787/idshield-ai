...
export const MOCK_SCREENING_RECORDS: ScreeningRecord[] = [
  ...
  },
  {
    ...
    document: {
      ...
      categoryLabel: 'Commercial Driving Licence',
      documentNumber: 'DL-55209-CAL',
      ...
      gender: 'M',
      rawUploadedFileName: 'dl_henderson_scan.png',
      fileSizeBytes: 1540100,
      uploadedAt: '2026-09-09T09:18:00Z',
      imageUrl: createDocPlaceholderSvg('State Driver License', 'DL-55209-CAL', '#047857', 'DEMO RECORD #4'),
    },
    extractedFields: [
      { fieldName: 'License Number', extractedValue: 'DL-55209-CAL', confidence: 0.98, validationStatus: 'PASS' },
      ...
      { fieldName: 'Class Categories', extractedValue: 'CLASS A / COMMERCIAL', confidence: 0.95, validationStatus: 'PASS' },
    ],
    validation: {
      overallValid: true,
      score: 94,
      ...
      crossFieldConsistencyStatus: 'PASS',
      items: [
        { id: 'v-1', title: 'AAMVA PDF417 Barcode Match', category: 'mrz_validation', status: 'PASS', detail: '2D barcode payload matches printed card typography fields.' },
    ...
    riskAssessment: {
      riskScore: 12,
      riskLevel: 'LOW',
      primaryRiskSummary: 'Authentic driving credential with validated 2D barcode and intact holographic elements.',
      recommendedAction: 'CLEAR',
      explainableFactors: [
        { id: 'rf-1', factor: 'AAMVA Standard Barcode Verified', weight: 'LOW', impactPoints: 0, description: 'Payload signatures align.' },
      ],
    },
  },
  {
    ...
    document: {
      id: 'DOC-8823',
      category: 'permit',
      categoryLabel: 'Cross-Border Entry Authorization Permit',
      documentNumber: 'PRM-2026-88192',
      ...
      issuingAuthority: 'BORDER CONTROL DIVISION',
      gender: 'F',
      rawUploadedFileName: 'entry_permit_scan.pdf',
      fileSizeBytes: 2100400,
      uploadedAt: '2026-09-09T09:24:40Z',
      imageUrl: createDocPlaceholderSvg('Border Entry Permit', 'PRM-2026-88192', '#0284c7', 'DEMO RECORD #5'),
    },
    extractedFields: [
      { fieldName: 'Permit ID', extractedValue: 'PRM-2026-88192', confidence: 0.98, validationStatus: 'PASS' },
      { fieldName: 'Holder Name', extractedValue: 'HARPREET KAUR SINGH', confidence: 0.96, validationStatus: 'PASS' },
      { fieldName: 'Permit Type', extractedValue: 'TRANSIT & RESIDENCY', confidence: 0.95, validationStatus: 'PASS' },
    ...
    riskAssessment: {
      riskScore: 10,
      riskLevel: 'LOW',
      primaryRiskSummary: 'Valid travel authorization permit with verified digital signatures.',
      recommendedAction: 'CLEAR',
      explainableFactors: [
